"""
NOTE: This contains duplicate code from `chives.cmds.plots`.
After `chives plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
import pkg_resources
from chives.plotting.create_plots import create_plots, resolve_plot_keys
...
def plot_chives(args, root_path):
    if args.size < 29 and not args.override:
