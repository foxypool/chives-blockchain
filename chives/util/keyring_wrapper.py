...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ chives passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Chives Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Chives Passphrase"
...
class KeyringWrapper:
    ...
    def migrate_legacy_keyring_interactive(self):
        ...
        """
        from chives.cmds.passphrase_funcs import async_update_daemon_migration_completed_if_running
