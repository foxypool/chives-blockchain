...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.chives.net"
            testnet_dns_introducer = "dns-introducer-testnet7.chives.net"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.chives.net"
            mainnet_dns_introducer = "dns-introducer.chives.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running chives services for changes to take effect")
