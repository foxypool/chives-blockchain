...
{
    Write-Output "Chives requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Try the Quick Start Guide to running chives-blockchain:"
Write-Output "https://github.com/HiveProject2021/chives-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'chives init' to begin."
