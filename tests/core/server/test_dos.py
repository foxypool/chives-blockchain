...
from chives.protocols.shared_protocol import Handshake
from chives.server.outbound_message import make_msg, Message
...
class TestDos:
    ...
    async def test_spam_tx(self, setup_two_nodes):
        ...
        ws_con: WSChivesConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSChivesConnection = list(server_2.all_connections.values())[0]
