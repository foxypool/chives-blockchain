...
from chives.wallet.derive_keys import master_sk_to_singleton_owner_sk
...
class WalletRpcApi:
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("xcc_target_address")
        pool_target = config["pool"].get("xcc_target_address")
        found_farmer = False
        found_pool = False
