...
We have some great improvements in this release: We launched our migration of keys to a common encrypted keyring.yaml file, and we secure this with an optional passphrase in both GUI and CLI. We've added a passphrase hint in case you forget your passphrase. More info on our [wiki](https://github.com/HiveProject2021/chives-blockchain/wiki/Passphrase-Protected-Chives-Keys-and-Key-Storage-Migration). We also launched a new Chiveslisp compiler in clvm_tools_rs which substantially improves compile time for Chiveslisp developers. We also addressed a widely reported issue in which a system failure, such as a power outage, would require some farmers to sync their full node from zero. This release also includes several other improvements and fixes.

### Added

- Added support for keyring migration from keychain, and the addition of passphrase support. Learn more at our [wiki](https://github.com/HiveProject2021/chives-blockchain/wiki/Passphrase-Protected-Chives-Keys-and-Key-Storage-Migration).
...
- Thanks to @yshklarov for help fixing [#7273](https://github.com/HiveProject2021/chives-blockchain/issues/7273), which bundled CA store to support pools for some farming systems, including M1 Apple computers. This enables those machines to properly connect to pools, and fixes the issue.
...
OG plots made before this release can continue to be farmed side by side with the new portable pool plots but can not join pools using the official pooling protocol. You can learn more as a farmer by checking out the [pool user guide](https://github.com/HiveProject2021/chives-blockchain/wiki/Pooling-User-Guide). Pool operators and those wanting to understand how the official pooling protocol operates should check out our [pooling implementation reference repository](https://github.com/HiveProject2021/pool-reference). If you plan to use plot NFT, all your farmers and harvesters must be on 1.2.0 to function properly for portable pool plots.
...
- You should review the [release notes for v1.0.2](https://github.com/HiveProject2021/chives-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
- Some users can't plot in the GUI in MacOS Big Sur - especially on M1. See issue [1189](https://github.com/HiveProject2021/chives-blockchain/issues/1189)
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/HiveProject2021/chives-blockchain/releases/tag/1.0rc1) was well.
...
- There is now remote UI support. [Documents](https://github.com/HiveProject2021/chives-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/HiveProject2021/chives-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- Significant improvements have been made to how the full node handles the mempool. This generally cuts CPU usage of node by 2x or more. Part of this increase is that we have temporarily limited the size of transactions. If you want to test sending a transaction you should keep the value of your transaction below 20 TXCH as new consensus will cause you to use a lot of inputs. This will be returned to the expected level as soon as the integration of [clvm rust](https://github.com/HiveProject2021/clvm_rs) is complete.
...
- A segfault caused by memory leaks in bls-library has been fixed. This should end the random farmer and harvester crashes over time as outlined in [Issue 500](https://github.com/HiveProject2021/chives-blockchain/issues/500).
...
- In the GUI there was [a regression](https://github.com/HiveProject2021/chives-blockchain/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/HiveProject2021/chives-blockchain/issues/485) where log level could no longer be set by service.
...
- The GUI now supports translations and localizations. If you'd like to add your language you can see the examples in [the locales directory](https://github.com/HiveProject2021/chives-blockchain/tree/dev/electron-react/src/locales) of the chives-blockchain repository.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/HiveProject2021/chives-blockchain/wiki) and placed in [INSTALL](https://github.com/HiveProject2021/chives-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/HiveProject2021/chives-blockchain/wiki/Quick-Start-Guide)
...
- We suggest you take a look at our [Upgrading documentation](https://github.com/HiveProject2021/chives-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- There is a new command `chives init` that will migrate files and generate your initial configuration. If you want to use the Wallet or farm, you will also have to `chives-generate-keys`. You can read step by step instructions for [upgrading from a previous beta release](https://github.com/HiveProject2021/chives-blockchain/wiki/Updating-beta-software). If you've set `$CHIVES_ROOT` you will have to make sure your existing configuration remains compatible manually.
...
- We have revamped the chives management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `chives-start-farmer &`. The [README.md](https://github.com/HiveProject2021/chives-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
[unreleased]: https://github.com/HiveProject2021/chives-blockchain/compare/1.0beta5...dev
[1.0beta5]: https://github.com/HiveProject2021/chives-blockchain/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/HiveProject2021/chives-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/HiveProject2021/chives-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/HiveProject2021/chives-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/HiveProject2021/chives-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/HiveProject2021/chives-blockchain/releases/tag/Alpha-1.0
